...
export const searchLibrariesSchema = z.object({
    ...
    region: z
        .string()
        .optional()
        .describe("지역코드 (11=서울, 21=부산, 22=대구, 23=인천, 24=광주, 25=대전, 26=울산, 29=세종, 31=경기, 32=강원, 33=충북, 34=충남, 35=전북, 36=전남, 37=경북, 38=경남, 39=제주)"),
    dtl_region: z
        .string()
        .optional()
...
export const searchBooksSchema = z.object({
    ...
    sort: z
        ...
        .optional()
        .describe("정렬필드 (title=도서명, author=저자명, pub=출판사, pubYear=출판년도, isbn=ISBN, loan=대출횟수)"),
    order: z
        .enum(["asc", "desc"])
        .optional()
...
export const searchPopularBooksSchema = z.object({
    ...
    age: z
        .string()
        .optional()
        .describe("연령코드 (0=영유아, 6=유아, 8=초등, 14=청소년, 20=20대, 30=30대, 40=40대, 50=50대, 60=60세이상)"),
    region: z
        .string()
        .optional()
        .describe("지역코드 (11=서울, 21=부산, 22=대구, 23=인천, 24=광주, 25=대전, 26=울산, 29=세종, 31=경기, 32=강원, 33=충북, 34=충남, 35=전북, 36=전남, 37=경북, 38=경남, 39=제주)"),
    ...
    addCode: z
        .string()
        .optional()
        .describe("ISBN부가기호 (0=교양, 1=실용, 2=여성, 4=청소년, 5=학습참고서(중고), 6=학습참고서(초등), 7=아동, 9=전문)"),
    kdc: z
        .string()
        .optional()
        .describe("대주제분류 (0=총류, 1=철학, 2=종교, 3=사회과학, 4=자연과학, 5=기술과학, 6=예술, 7=언어, 8=문학, 9=역사)"),
    dtl_kdc: z
        .string()
        .optional()
...
export const searchLibraryCodesSchema = z.object({
    libraryName: z
        .string()
        .optional()
        .describe("도서관명으로 검색 (부분 검색 및 유사검색 지원, 예: '중앙도서관', '강남', '시립') - 오타나 불완전한 이름도 검색 가능"),
    regionName: z
        .string()
        .optional()
...
export const getDetailedRegionCodesSchema = z.object({
    region: z
        .string()
        .describe("상위 지역코드 (11=서울, 21=부산, 22=대구, 23=인천, 24=광주, 25=대전, 26=울산, 29=세종, 31=경기, 32=강원, 33=충북, 34=충남, 35=전북, 36=전남, 37=경북, 38=경남, 39=제주)"),
});
// 세부주제 코드 조회 스키마
export const getDetailedSubjectCodesSchema = z.object({
    kdc: z
        .string()
        .describe("대주제분류코드 (0=총류, 1=철학, 2=종교, 3=사회과학, 4=자연과학, 5=기술과학, 6=예술, 7=언어, 8=문학, 9=역사)"),
});
